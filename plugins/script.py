...
# Add the image URL here
    IMAGE_URL = "https://graph.org/file/3914354a76ff708b3983f.jpg"
...
𖣔 YᴏᴜTᴜʙᴇ ʟɪɴᴋ sᴜᴘᴘᴏʀᴛ ✓

𖣔 Gᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ʟɪɴᴋ sᴜᴘᴘᴏʀᴛ ✓

𖣔 Zᴇᴇ5 sʜᴏᴡs sᴜᴘᴘᴏʀᴛ ✓

𖣔 Mᴇᴅɪᴀᴅɪʀᴇ ʟɪɴᴋ sᴜᴘᴘᴏʀᴛ ✓

𖣔 Vᴏᴏᴛ sʜᴏᴡs sᴜᴘᴘᴏʀᴛ ✓

𖣔 Tɪᴋᴛᴏᴋ ʟɪɴᴋ sᴜᴘᴘᴏʀᴛ ✓

𖣔 Fᴇᴍʙᴇᴅ ʟɪɴᴋ sᴜᴘᴘᴏʀᴛ ✓

𖣔 sᴇɴᴅ /delthumb ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴛʜᴜᴍʙɴᴀɪʟ.

𖣔 ᴄᴏɴғɪɢᴜʀᴇ ᴍʏ sᴇᴛᴛɪɴɢs ᴛᴏ ᴄʜᴀɴɢᴇ ᴜᴘʟᴏᴀᴅ ᴍᴏᴅᴇ

𖣔 sᴇɴᴅ /showthumb ᴛᴏ ᴠɪᴇᴡ ᴄᴜsᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ.
 
"""
    ABOUT_TEXT = """
**📛 Mʏ Nᴀᴍᴇ :** : [ᴜᴘʟᴏᴀᴅᴇʀ ʙᴏᴛ](https://t.me/UploaderxyRobot)

**📍 Cʜᴀɴɴᴇʟ :** : [Aman World](https://t.me/AMAN_WORLD)

**⛲ Sᴏᴜʀᴄᴇ :** : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/LegendRobot)

**🚨 Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ :** : [Aman Support](https://t.me/opamanxworld)

**📖 Lᴀɴɢᴜᴀɢᴇ : :** [Pʏᴛʜᴏɴ 3.12.2](https://www.python.org/)

**Fʀᴀᴍᴇᴡᴏʀᴋ :** [ᴘʏʀᴏɢᴀᴍ 2.0.106](https://docs.pyrogram.org/)

**🗄️ Bᴏᴛ Sᴇʀᴠᴇʀ :** I DON'T KNOW

**👩‍💻 Dᴇᴠᴇʟᴏᴘᴇʀ :** @LegendRobot
"""
...
"""
    ...
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/ThankTelegram'>@LegendRobot</a>"
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @AMAN_WORLD \n For the list of Telegram bots. "
    EXTRACT_ZIP_INTRO_ONE = "Send a compressed file first, Then reply /unzip command to the file."
    EXTRACT_ZIP_INTRO_THREE = "Analyzing received file. ⚠️ This might take some time. Please be patient. "
    UNZIP_SUPPORTED_EXTENSIONS = ("zip", "rar")
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/ThankTelegram'>@LegendRobot</a>"
